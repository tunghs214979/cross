...
public class ShowLogChartsForIPTables {
    ...
    public ShowLogChartsForIPTables(String jsonFilePath, String pieChartField, String timeSeriesChartField) {
        try {
    ...
    public HBox createCharts() {
        try {
            ...
            pieChartFX = new PieChartFX(jsonArray, pieChartField);
            PieChart pieChart = pieChartFX.createChart();
            timeSeriesChartFX = new TimeSeriesChartFX(jsonArray, timeSeriesChartField);
    ...
    public class PieChartFX {
        ...
        public PieChartFX(JSONArray jsonArray, String field) {
    ...
    public class TimeSeriesChartFX {
        ...
        public TimeSeriesChartFX(JSONArray jsonArray, String field) {
            this.jsonArray = jsonArray;
            this.field = field;
        }
